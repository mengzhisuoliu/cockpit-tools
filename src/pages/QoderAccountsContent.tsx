...
export type QoderAccountsContentTab = 'overview' | 'instances';

interface QoderAccountsContentProps {
  activeTab: QoderAccountsContentTab;
}
...
export function QoderAccountsContent({ activeTab }: QoderAccountsContentProps) {
